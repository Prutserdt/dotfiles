...
My Arduino ESP32 IDE setup. Uploading PowerStrike testing
#+begin_src emacs-lisp :tangle config.el
...
My Arduino ESP32 IDE setup. Uploading PowerStrike code to ESP32 by Arduino and moving windows around mimicking an IDE.
#+begin_src emacs-lisp :tangle config.el
...
Show the serial output of my ESP32.
#+begin_src emacs-lisp :tangle config.el
