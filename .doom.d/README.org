...
Some custom function are added below. Used in my Arduino ESP32 IDE setup. Uploading PowerStrike testing. Remark: (interactive) is needed to be able to run with hotkeys.
#+begin_src emacs-lisp :tangle config.el
...
Close the *Async Shell Command* window when it generates the output "Hard resettign via RTS pin..."
TODO: Does not work yet...
Show the serial output of ttyUSBo at 115200 baudrate, the setting of ESP32.
#+begin_src emacs-lisp :tangle config.el
