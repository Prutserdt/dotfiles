...
Show the current roam directory in the notification area of Emacs and show additional information as: the amount of org files, total lines and word count of all org files.
FIXME: I would like to include the information of the daily subdirectory, but did not get this to work yet...
#+BEGIN_SRC emacs-lisp :tangle config.el :results silent
