...
Show information about the org-roam files, list the amount of org files, amount of lines and amount of words in the org-roam directory and daily subdirectory.
#+BEGIN_SRC emacs-lisp :tangle config.el :results silent
