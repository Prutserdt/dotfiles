...
* init.el
This file controls what Doom modules are enabled and what order they load in. The list of available modules can be checked in Doom Emacs by ~M-x~ ~Doom/help-modules~ and added to this list if needed.
...
More keybindings will be added.....
#+begin_src emacs-lisp :tangle config.el
