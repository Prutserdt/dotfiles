...
+begin_src emacs-lisp :tangle snippets/org-mode/PythonBlock

#+begin_src :tangle snippets/org-mode/PythonBlock
# -*- mode: snippet -*-
# name: PythonBlock
# key: <p
# --
...
Remark: I end the codeblock this way to include this line, in org-mode #+end_src would end this codeblock and it would not have been added.
