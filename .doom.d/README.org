...
** General settings
Set the default mode of the scratch buffer to be org, inspired by [[https://blog.karssen.org/2014/07/28/changing-the-default-mode-of-the-emacs-scratch-buffer][this source]] and add a initial scratch message.
#+begin_src emacs-lisp :tangle config.el
