...
** General settings
Make the scrolling experience more smooth by the following package:
#+begin_src emacs-lisp :tangle config.el
(pixel-scroll-mode 0)
#+end_src
...
FIXME: first setup of my dailies capture tempate... copy/paste of https://org-roam.discourse.group/t/daily-task-management-with-org-agenda-and-org-roam-dailies/989/16
Really cool! Need to add a todo list... :-)
