...
Maak een lijst van source code blocks. De output
#+name: php-files
...
Voorbeeld van tangling met sudo privileges: ~begin_src php :tangle "/sudo::/srv/http/ide.php"~

//#+begin_src php :tangle "/sudo::/srv/http/ide.php"
#+begin_src php
<?php
