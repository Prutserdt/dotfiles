...
* About this document
This document consists of notes that I took during my Linux journey. A *lot* of them are obsolete, faulty and inefficient. I wrote things down to memorize them better and to keep as a reference. This file is quite lengthy as counted in the following code block:
#+NAME: wordcounting
#+begin_src elisp
(count-lines-page)
#+end_src
...
: Page has 4802 lines (32 + 4771)

#+CALL: wordcounting()

#+RESULTS:
: Page has 4802 lines (38 + 4765)
