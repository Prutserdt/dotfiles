...
- [[#command-line-tricks][Command line tricks]]
  - [[#zoeken-van-een-textstring-in-meerder-files-met-grep][Zoeken van een textstring in meerder files met grep]]
  - [[#weergave-hard-drive-formatting-dd-etc][Weergave hard drive, formatting, dd, etc]]
  - [[#memory-stick-niet-zichtbaar-met-lsblk][Memory stick niet zichtbaar met lsblk]]
  - [[#multiple-linux-distros-on-one-usb][Multiple linux distros on one USB:]]
  - [[#converteren-van-pdf-naar-een-tekstfile-bijv-voor-rabo-pdf-voor-import-in-gnumeric][Converteren van pdf naar een tekstfile, bijv. voor rabo pdf voor import in gnumeric]]
  - [[#converteren-van-pdf-naar-een-tekstfile-en-verwijderen-van-bagger-en][Converteren van pdf naar een tekstfile en verwijderen van bagger en]]
  - [[#removing-of-password-of-pdf-met-package-xpdf][Removing of password of pdf. Met package xpdf.]]
  - [[#removing-size-of-pdf-shrinking-size-by-ghostscript-package][Removing size of pdf. Shrinking size by ghostscript package:]]
  - [[#roteren-van-pdfs][Roteren van pdfs]]
  - [[#pdfs-in-dark-mode-weergeven][pdfs in dark mode weergeven]]
  - [[#calender][Calender]]
  - [[#rechten-bestanden][Rechten bestanden]]
  - [[#logging][Logging]]
  - [[#wissen-van-regels-in-meerdere-bestanden-die-een-bepaald-woord-bevatten][Wissen van regels in meerdere bestanden die een bepaald woord bevatten.]]
  - [[#linux-keyboard-shortcuts][Linux keyboard shortcuts]]
  - [[#batch-rename-image-files][Batch rename image files]]
  - [[#pacmanyaourtyay][PACMAN/YAOURT/YAY]]
  - [[#wifi][WIFI]]
  - [[#vnc-controle-van-desktop-van-buitenafoa-android-phone][VNC (controle van desktop van buitenaf,oa android phone)]]
  - [[#manipuleren-van-ge-unicorn][Manipuleren van GE UNICORN]]
  - [[#perform-google-search-from-commandline-tuxi][Perform google search from commandline: tuxi]]
  - [[#bluetooth-instellen][Bluetooth instellen]]
  - [[#vpn][VPN]]
  - [[#samba-instellen][Samba instellen]]
  - [[#fonts-installeren][Fonts installeren]]
  - [[#sqlite3-database][SQlite3 database]]
  - [[#corona-script][Corona script]]
  - [[#downloaden-degiro-porfolio-data-en-berekenen-percentage][Downloaden DeGiro porfolio data en berekenen percentage.]]
  - [[#video-card-information][Video card information]]
  - [[#create-superfast-ramdisk][Create Superfast ramdisk]]
  - [[#rss-stuff][RSS stuff]]
  - [[#ff2mpv][ff2mpv]]
  - [[#python-programming-tricks][Python programming tricks]]
  - [[#c-programming-tricks][C programming tricks]]
  - [[#zsh-en-oh-my-zhs][ZSH en Oh-my-zhs]]
  - [[#downgrade-downgraden-van-pacakges-met-de-applicatie-downgrade][Downgrade, downgraden van pacakges met de applicatie downgrade]]
  - [[#vergelijken-van-twee-textfiles-comparing-two-text-files][Vergelijken van twee textfiles. Comparing two text files.]]
  - [[#electrum-crypto-wallet][Electrum, crypto wallet]]
- [[#applications-command-line-and-guis][Applications (Command line and GUIs)]]
  - [[#vim][Vim]]
  - [[#verwijderen-spaties-aan-begin-van-regel][Verwijderen spaties aan begin van regel:]]
  - [[#renaming-in-vim-fout----goed][Renaming in vim (fout --> goed)]]
  - [[#sorting-in-vim][Sorting in vim]]
  - [[#veranderen-van-tabbing-naar-spaces][Veranderen van tabbing naar spaces]]
  - [[#batch-renaming-in-vimvifm][Batch renaming in vim/vifm]]
  - [[#fzf-fuzzy-finder][fzf (fuzzy finder)]]
  - [[#ranger-terminal-file-browser][Ranger (terminal file browser)]]
  - [[#figlet][figlet]]
  - [[#vifm][vifm]]
  - [[#urxvt-lightweight-terminal-kleurenschema-kun-je-met-pywal-instellen--][urxvt (lightweight terminal). Kleurenschema kun je met pywal instellen :-)]]
  - [[#cmus-terminal-music-player][cmus. Terminal music player]]
  - [[#cava][cava]]
  - [[#pywal][Pywal.]]
  - [[#nano][Nano]]
  - [[#octave][Octave]]
  - [[#git-en-dotfiles-procedure][Git (en dotfiles procedure)]]
  - [[#nieuwe-poging-tot-het-toevoegen-van-een-key-aan-github-06feb22][Nieuwe poging tot het toevoegen van een key aan github, 06Feb22:]]
  - [[#add-an-additional-dotfile-to-this-repo][Add an additional dotfile to this repo]]
  - [[#remove-an-existing-dotfile-from-this-repo][Remove an existing dotfile from this repo]]
  - [[#how-to-setup-a-new-dotfiles-repo][How to setup a new dotfiles repo]]
  - [[#how-to-add-the-dotfiles-of-this-repo-to-a-new-linux-pc][How to add the dotfiles of this repo to a new Linux pc.]]
  - [[#force-update-from-local-to-github-repo][Force update from local to github repo:]]
  - [[#add-my-suckless-utilities-to-my-repo][Add my suckless utilities to my repo:]]
  - [[#download-github-files-to-pc-by-wget][Download github files to pc by wget]]
  - [[#tox][Tox]]
  - [[#sxiv][SXIV]]
  - [[#neomutt][Neomutt]]
  - [[#steam][Steam]]
  - [[#openshot-appimage][Openshot appimage]]
  - [[#stack-client][Stack client]]
  - [[#copy-pictures-of-mac-to-linux][Copy pictures of mac to linux]]
  - [[#vpn-1][VPN]]
  - [[#virtualbox-en-whonix][Virtualbox en Whonix]]
  - [[#arduino-probleem-oplossen][Arduino probleem oplossen]]
  - [[#arduino][Arduino]]
  - [[#esp32-cam-setup-esp32-libs-via-arduino-cli][ESP32 cam, setup esp32 libs, via Arduino-cli]]
  - [[#esp32-cam-via-arduino-ide][ESP32 CAM, via arduino IDE]]
  - [[#esp32-cam-alleen-voor--installatie][ESP32 CAM, alleen voor  installatie]]
  - [[#doom-emacs][Doom Emacs]]
- [[#distros][Distros]]
  - [[#xfce-tricks][XFCE tricks]]
  - [[#thunar][Thunar]]
  - [[#i3-window-manager][i3 window manager]]
  - [[#emojis-in-dmenu][Emojis in dmenu]]
  - [[#install-on-persistent-usb-feb2017][Install on persistent USB feb2017]]
  - [[#ubuntu-1610-server-en-network][Ubuntu 16.10 server en network]]
  - [[#ubuntu-mate-op-gpd-pocket][Ubuntu Mate op GPD pocket]]
  - [[#kali-linux-op-gpd-pocket][Kali linux op GPD pocket]]
  - [[#install--i3-arch-op-werk-pc-december-2020-via-dotfile-en-git][Install  i3 Arch op werk pc (december 2020), via dotfile en GIT]]
- [[#tiling-windowmanagers][Tiling windowmanagers]]
  ...
  - [[#dmenu][dmenu]]
- [[#keebs][Keebs]]
  - [[#ducky-one-mechanical-keyboard][Ducky one mechanical keyboard]]
  - [[#vortex-90m-mechanical-keyboard][Vortex 90M mechanical keyboard]]
  - [[#gergo-mechanical-ortholinear-keyboard][Gergo mechanical ortholinear keyboard]]
  - [[#redox-keyboard-falba-teck-nov2020][Redox keyboard, falba teck (NOV2020)]]
