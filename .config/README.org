...
- [[#my-dmenu-scripts][My dmenu scripts]]
  ...
  - [[#dmenuappssh-1][dmenuapps.sh]]
  - [[#dmenubackupsh-1][dmenubackup.sh]]
...
# Use dmenu to select the directory containing your images
selected_directory=$(find "$HOME/Downloads" -maxdepth 1 -type d | sort | dmenu -c -bw 2 -l 40 -p "Select a directory for pictures which you want to move to the subdir Minder_en_dubbelop:")
