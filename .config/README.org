...
** dmenuthunar.sh
FIXME: I migrated to PCManFM... need to chang the names etc...
...
The old version, used for Thunar
...
FIXME: ik wil gtk-3 gebruiken als bookmarks denk ik... Maar ik heb nu gewoon copy/paste aanpassen gedaan.
