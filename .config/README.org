...
To make the tangling process easier I am using the [[https://github.com/yilkalargaw/org-auto-tangle] org-auto-tangle] package which automatically tangles the files. The file contains ~#+auto_tangle: t~ in the header.
