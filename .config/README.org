...
** dmenuthunar.sh
A dmenu script to open directories in pcmanfm. The name is incorrect and thunar is not used, but I keep it like this for now.
...
#+END_SRC
And copy the content of this gtk directory to the directories file(with slight modifications):
#+BEGIN_SRC emacs-lisp :results none
