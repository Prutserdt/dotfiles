...
notify-send -t 1000 "Clipboard management opened"
...
while true; do
    ...
    if [[ -z "$selected_action" ]]; then
        notify-send -t 1000 "Exiting clipboard menu"
        exit 0
    fi
    ...
    case "$selected_action" in
       ...
       "2. Show List of Saved Clipboards")
            ...
            notify-send -t 1000 "Viewing $selected_file"
            ...
            if [[ -f "$clipboard_dir/$selected_file" ]]; then
                ...
                notify-send -t 1000 "Back to clipboard menu"
            else
