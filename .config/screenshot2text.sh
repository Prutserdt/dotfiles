...
ramdir="/dev/shm/temp"
mkdir $ramdir &
notify-send -t 1000 "Running screenshot2text" "Select an area with mouse 🐭 to convert to text"
...
notify-send -t 1000 "Text created from screenshot" "$(cat $screenshot_txt.txt)"
