...
static Key keys[] =
{
    ...
    { 0,               XF86XK_Calculator,	   togglescratch,  {.ui = 2 } },                                                    /* Open calculator in scratchpad */
 ...
 * https://github.com/bakkeby/dawn/blob/master/dawn.c
 *
 *	{ MODKEY,                       XK_comma,  focusstack,     {.i = +2 } },
 *	{ MODKEY,                       XK_period, focusstack,     {.i = -2 } },
 */	
