...
notify-send -t 1000 "Running dmenubackup.sh" &&
...
if [ "$answer" != "${answer#[Yy]}" ] ;then
    ...
    notify-send -t 1000 "Thank you. A backup of dmenu was made to"
else
    echo No
    notify-send -t 1000 "Exiting dmenubackup.sh" "No backup was made"
fi
