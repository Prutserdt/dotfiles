...
FIXME: the rainbow-delimiters package caused issues and I removed it after manually adding it and it is now in custom.el. I will remove it once this is working as intended on all my machines.
...
FIXME: org-superstart does not work anymore it is now org-modern-star
#+BEGIN_SRC emacs-lisp :tangle config.el :results silent
