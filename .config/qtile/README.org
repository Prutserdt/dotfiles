...
To get insight of qtile the sourcecode can be checked (usr/lib/python3.10/site-packages/libqtile, or alternatively run from python shell: ~import libqtile~ and ~print(help(libqtile))~.
