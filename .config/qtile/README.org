#+TITLE: Configuration of qtile tiling window manager
...
- [[#about-this-org-config-file][About this org config file]]
- [[#imports][Imports]]
- [[#variables][Variables]]
- [[#qtile-specific-keybindings][qtile specific keybindings]]
- [[#audio-keybindings][Audio keybindings]]
- [[#application-keybindings][Application keybindings]]
- [[#text-files-keybindings][Text files keybindings]]
- [[#groups][Groups]]
- [[#layouts][Layouts]]
- [[#startup-applications][Startup applications]]

* About this org config file

In this emacs org document the configuration of the window manager qtile is described.
This file is used as the source to create [[https://github.com/Prutserdt/dotfiles/blob/master/.config/qtile/config.py][config.py]].

* Imports
The python configuration requires some modules to be loaded.
...
* Variables
Some variables are set to bind hotkeys
The modL is the left superkey (windows key) and is bound to qtile specific bindings, for instance move windows around.
modR is the right superkey (windows key) and is used to open applications.
altR is the right alt key and is used to open text files.
...
The right superkey is used to open applications.
...
* Text files keybindings
The right alt key is used to open textfiles in Vim in the terminal.
...
#+END_SRC
* Groups
Here the workspaces are described.
